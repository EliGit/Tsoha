...
INSERT INTO user SET id=1, username="user1", password="user1",firstname="Jari",lastname="Virtanen",address="Katu 16, 00100, Helsinki",email="email@email.com",phone="123456789",rank=0;
INSERT INTO user SET id=2, username="user2", password="user2",firstname="Kari",lastname="Virtanen",address="Katu 16, 00100, Helsinki",email="email1@email.com",phone="987654321",rank=0;
